...
public class EmployeeDaoImpl implements EmployeeDao
{
	...
	{
		Query query = getSession().createQuery("select emp from Employee emp");
	...
	{
		Query query = getSession().createQuery("update Employee emp set ename=:ename,dob=:dob,phone=:phone,email=:email,doj=:doj,gender=:gender,postHeld=:postHeld,address=:address,password=:password,deptName=:deptName,deptId=:deptId  where eid =:eid");
		...
		query.setParameter("deptName",employee.getDeptName());
		query.setParameter("deptId",employee.getDeptId());
